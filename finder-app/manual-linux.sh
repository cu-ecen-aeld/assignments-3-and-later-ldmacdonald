...
# TODO: Create necessary base directories, moving home/conf to below
cd "$OUTDIR"
...
# Path Library Lookup for to copy dependencies to rootfs
cd ${OUTDIR}/rootfs
PATH_LIBRARY=$(aarch64-none-linux-gnu-gcc -print-sysroot)
...
# Using sed stream editor to do an instream replacement of assignement.txt path while writing into new file in rootfs
